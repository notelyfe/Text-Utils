...
const About = () => {
    ...
    const toggleStyle = () => {
        ...
        mode.color === 'black' ? SetBtnText("Disable Dark Mode") : SetBtnText('Enable Dark Mode')
    }
        ...
        <div className='container'>
            ...
            <div className="accordion" id="accordionExample" style={mode}>
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample" style={mode}>
                        <div className="accordion-body">
